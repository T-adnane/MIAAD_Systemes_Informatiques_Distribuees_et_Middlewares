 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ServeurJWS.example.com/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ServeurJWS.example.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ServeurJWS.example.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServeurJWS.example.com/", "BanqueServicePort"), BanqueService.class, features);
    }
